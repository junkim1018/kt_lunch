...
const restaurantDB = [
...

  {
    ...
    walk: "도보 6분 (스타필드 그랑서울 1층, 종각역 직결)",
    rating: "4.5",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["mild","cold","rainy"],
...

  {
    ...
    waiting: true,
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "오픈 11시에 맞춰도 사람 가득! 평일 20분 웨이팅 각오. 회전율 빠른 편이라 기다릴 가치 충분. 광화문~시청 순대국 탑티어.",
    naver: "https://map.naver.com/v5/search/농민백암순대+시청",
    reservation: []
  },
...

  {
    ...
    waiting: true,
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "🌟 미쉐린 빕구르망 선정! 깔끔하고 담백한 사골육수에 쫄깃한 면. 광화문에서 조금 걷지만 웨이팅 각오하고 갈 가치 충분.",
    naver: "https://map.naver.com/v5/search/황생가칼국수+안국",
    reservation: []
  },
...

  {
    ...
    price: "15,000~26,000원",
    priceNote: "1인 평균 1.5~2.5만원",
    walk: "도보 12분 (인사동8길, 안국역/인사동)",
    rating: "4.7",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["cold","rainy","mild"],
    ...
    waiting: true,
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "🏯 인사동 한옥 7채를 터서 만든 고즈넉한 한식 맛집. 마약된장 국물 상추샤브샤브가 시그니처. 웨이팅 있으니 오픈 런 또는 캐치테이블 예약 추천.",
    naver: "https://map.naver.com/v5/search/최대감네+인사동",
    reservation: []
  },
...

  {
    ...
    budget: ["normal"],
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "🌟 미쉐린 가이드 서울 2024 선정! 스페인 듀록 돼지 등갈비+목살로 만든 특별한 국밥. 청양고추·케일 기름 베이스 육수가 청량하고 중독적. 광화문 국밥 맛집 최상위.",
    naver: "https://map.naver.com/v5/search/안암+안국역+돼지국밥",
    reservation: [
      { label: "네이버 예약", url: "https://map.naver.com/v5/search/안암+안국역", color: "#03C75A" },
    ]
  },

  {
    ...
    price: "20,000~28,000원",
    priceNote: "1인 평균 2.2만원",
    walk: "도보 16분 (안국역 인근 한옥마을)",
    rating: "4.6",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["mild","hot"],
    ...
    waiting: true,
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "안국역 한옥마을 속 분위기 맛집. 맛과 분위기 모두 잡은 파스타·피자. 특별한 점심·외국인 손님 접대에 최적. 웨이팅 많으니 미리 예약 필수!",
    naver: "https://map.naver.com/v5/search/스미스가좋아하는한옥+안국",
    reservation: [
      { label: "캐치테이블", url: "https://app.catchtable.co.kr/ct/shop/smithhanok", color: "#FF6B35" },
      { label: "네이버 예약", url: "https://map.naver.com/v5/search/스미스가좋아하는한옥+안국", color: "#03C75A" },
    ]
  },
...

  {
    ...
    budget: ["normal"],
    calorie: { emoji: "🟡", label: "보통칼로리", color: "#f5a623" },
    reason: "다이닝코드 4.7★ 안국역 라멘 1위! 진하고 농후한 돈코츠 국물. 두툼한 차슈가 일품. 추운 날 라멘 한 그릇으로 완벽한 점심.",
    naver: "https://map.naver.com/v5/search/오레노라멘+안국",
    reservation: []
  },

  {
    ...
    budget: ["normal"],
    calorie: { emoji: "🟢", label: "저칼로리", color: "#03C75A" },
    reason: "한우육회와 신안 뻘낙지에 청양고추·볶은참깨를 버무린 남도식 탕탕이 전문점. 신선한 육회 한 접시로 기분 전환. 경복궁역 인근 숨은 맛집.",
    naver: "https://map.naver.com/v5/search/우당탕탕+경복궁역",
    reservation: [
      { label: "네이버 예약", url: "https://map.naver.com/v5/search/우당탕탕+경복궁역", color: "#03C75A" },
    ]
  },
...

  {
    ...
    price: "11,000~16,000원",
    priceNote: "1인 평균 1.3만원",
    walk: "도보 5분 (종로5길 32-5, 종각역 2번출구 289m)",
    rating: "4.6",
    ribbon: true,
    diet: ["nodiet"],
    weather: ["cold","rainy","mild"],
...

  {
    ...
    priceNote: "1인 평균 1.3만원",
    walk: "도보 9분 (중구 남대문로5길 23, 시청역 7번 출구 350m)",
    rating: "4.8",
    ribbon: false,
    diet: ["light","nodiet"],
    weather: ["cold","rainy"],
...

  {
    ...
    price: "8,000~25,000원",
    priceNote: "1인 평균 1.2만원",
    walk: "도보 2분 (세종대로23길 3, 광화문역 8번출구 92m)",
    rating: "4.2",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["cold","rainy","mild"],
...

  {
    ...
    price: "9,500~15,000원",
    priceNote: "1인 평균 1.2만원",
    walk: "도보 5분 (센트로폴리스 1층, 종각역 3-1출구)",
    rating: "4.3",
    ribbon: false,
    diet: ["light","diet","vegetarian","nodiet"],
    weather: ["hot","mild"],
...

  {
    ...
    category: "샐러드 · 포케/샐러드볼/그릴보울",
    cuisine: "salad",
    menus: ["클래식 참치 포케 11,500원", "오리엔탈 두부 포케 9,500원 (비건)", "프로틴 치킨 포케 11,500원"],
    price: "9,500~15,000원",
    priceNote: "1인 평균 1.1만원",
    walk: "도보 12분 (한국생산성본부 B1, 경복궁역 인근)",
    rating: "4.2",
    ribbon: false,
    diet: ["light","diet","vegetarian","nodiet"],
    weather: ["hot","mild"],
    ...
    budget: ["cheap","normal"],
    calorie: { emoji: "🟢", label: "저칼로리", color: "#03C75A" },
    reason: "🥗 광화문 서쪽 슬로우캘리 지점. 포케·샐러드랩·스프 라인업. 비건 두부 포케는 완전 채식 가능. 점심 직장인 단골 건강식 맛집.",
    naver: "https://map.naver.com/v5/search/슬로우캘리+경복궁",
    reservation: []
  },
...

  {
    ...
    priceNote: "1인 평균 1.1만원",
    walk: "도보 5분 (종로 87-1 2층, 종각역 1번 출구 근처)",
    rating: "3.9",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["cold","rainy"],
...

  {
    ...
    priceNote: "1인 평균 1.8만원",
    walk: "도보 4분 (로얄빌딩 지하1층, 광화문역 1번 출구)",
    rating: "4.3",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["mild","cold","rainy"],
  ...
  },
  {
    ...
    price: "9,000~13,000원",
    priceNote: "1인 평균 1만원",
    walk: "도보 3분 (새문안로5길 31, 광화문역 1번 출구)",
    rating: "4.0",
    ribbon: false,
  ...
  },
  {
    ...
    category: "양식 · 이탈리안뷔페",
    cuisine: "western",
    menus: ["화덕피자", "파스타 4종", "리조또", "티라미수", "런치뷔페"],
    price: "19,900~24,000원",
    priceNote: "1부(11:30) 24,000원 / 2부(13:00) 19,900원, 평일만 뷔페 운영",
    walk: "도보 12분 (종로구 율곡로2길 7 서머셋팰리스 1층, 안국역 인근)",
    rating: "4.2",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["mild", "hot"],
    ...
    waiting: false,
    calorie: { emoji: "🔴", label: "고칼로리", color: "#e74c3c" },
    reason: "서머셋팰리스 1층 정통 이탈리안. 평일 런치뷔페로 화덕피자·파스타·디저트 무제한. 테라스석도 운영. 거래처 접대나 팀 점심으로 인기.",
    naver: "https://map.naver.com/p/search/더키친일뽀르노%20광화문",
    reservation: false,
  },
  {
    name: "뽐모도로",
    category: "양식 · 파스타",
    cuisine: "western",
    menus: ["크림 스파게티", "봉골레 스파게티", "아마트리치아나", "해산물 스파게티"],
    price: "18,000~22,000원",
    priceNote: "1인 평균 2만원, 양 많아 가성비 좋음",
    walk: "도보 3분 (종로구 새문안로9길 21 당주동, 광화문역 8번 출구)",
    rating: "4.0",
    ribbon: false,
    diet: ["nodiet"],
    weather: ["any"],
    ...
    reason: "1994년 오픈한 광화문 30년 전통 파스타 노포. 신라호텔 출신 셰프 운영. 진한 크림소스와 넉넉한 양이 특징. 점심 웨이팅 있음.",
    naver: "https://map.naver.com/p/search/뽐모도로%20광화문",
    reservation: false,
  },
  {
    name: "일품진진수라 광화문점",
  ...
  },
  {
    ...
    walk: "도보 3분 (세종문화회관 지하 1층, 광화문역 1번 출구 100m)",
    rating: 4.2,
    ribbon: false,
    diet: ["nodiet"],
    weather: ["any"],
  ...
  },
  {
    ...
    walk: "도보 3분 (케이트윈타워 B동 지하1층, 광화문역 도보권)",
    rating: 4.4,
    ribbon: false,
    diet: ["nodiet"],
    weather: ["any"],
